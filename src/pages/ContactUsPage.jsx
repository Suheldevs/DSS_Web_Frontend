...
const ContactUsPage = () => {
  ...
  const handleFileChange = (e) => {
    ...
    // append new files to previous selection
    setFormData((prev) => ({
      ...prev,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // handle file(s) separately
      if (formData.sitePhoto && formData.sitePhoto.length > 0) {
                ...
                <div className="space-y-3">
                      ...
                      {formData.sitePhoto && formData.sitePhoto.length > 0 ? (
                        <div className="space-y-2">
                          ...
                          <div className="mt-2">
                            ...
                            <label
                              ...
                              className="inline-block px-4 py-2 bg-emerald-600 text-white rounded-md cursor-pointer hover:bg-emerald-700 transition-colors text-sm"
                            >
                              Add More Files
                            </label>
                          </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            PNG, JPG, JPEG, WEBP, PDF up to 5MB
                          </p>
                          <input
                            type="file"
                            multiple
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <label className="text-sm text-gray-700">
                      ...
                      consent to being contacted by Digital Signage Solutions
