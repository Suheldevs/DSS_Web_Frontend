      ...
      <div className="max-w-7xl mx-auto px-4 py-8 ">
        ...
        <div className="text-center mb-4">
          ...
          <p className="lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover what sets Digital Signage Solutions UP apart — innovation,
            reliability, and a commitment to excellence in every display.
          </p>
        </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact" className="px-6 py-3 cursor-pointer bg-white text-green-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105">
